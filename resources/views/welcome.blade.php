                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="{{url('img/logo.png')}}" width="25" height="20"> <h2 class="text-xl font-semibold text-black">ToolHub</h2>
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                        Welcome to ToolTech Rentals, your one-stop destination for all your tool rental needs! At ToolTech, we take pride in providing high-quality tools and equipment to help you tackle any project, big or small. With a wide range of tools, from power drills to heavy-duty machinery, we are committed to empowering our customers with the right tools for the job.
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Contact Us</h2>
                            ...
                            <a class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                ...
                                <div class="flex size-12 shrink-0 items-center justify-center">
                                    <img src={{url('img/store.png')}}>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">View Products</h2>        
                                </div>
                            </a>
                        </div>
                    </main>
